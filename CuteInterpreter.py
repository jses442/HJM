...
class CuteInterpreter(object):
    ...
    def run_func(self, func_node):
        ...
        if func_node.type is TokenType.CAR:
            ...
            if not is_quote_list(expr_rhs1):
                ...
                result2 = pop_node_from_quote_list(expr_rhs2) ##4 5 6
                result.next = result2
                return create_quote_node(result,True)
            ...
            #작성
            if rhs1.type and rhs2.type is TokenType.INT and rhs1.value == rhs2.value : return self.TRUE_NODE
    ...
    def run_list(self, l_node):
        ...
        if op_code.type in \
            ...
            return self.run_binary(op_code)
